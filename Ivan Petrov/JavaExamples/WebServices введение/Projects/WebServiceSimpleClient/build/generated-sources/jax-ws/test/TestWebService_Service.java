 ...
 * 
 */
@WebServiceClient(name = "TestWebService", targetNamespace = "http://tests/", wsdlLocation = "http://localhost:9081/WebServiceSimpleServer/TestWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName TESTWEBSERVICE_QNAME = new QName("http://tests/", "TestWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9081/WebServiceSimpleServer/TestWebService?WSDL");
    ...
    public TestWebService getTestWebServicePort() {
        return super.getPort(new QName("http://tests/", "TestWebServicePort"), TestWebService.class);
    }
    ...
    public TestWebService getTestWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tests/", "TestWebServicePort"), TestWebService.class, features);
    }
